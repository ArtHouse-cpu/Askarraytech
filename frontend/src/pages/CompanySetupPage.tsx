    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      >
        <button
          ...
          className="w-full bg-[#D4AF37] hover:bg-[#F3C853] text-black rounded-2xl p-2.5 shadow-[0_12px_40px_rgba(212,175,55,0.4)] border border-[#F3C853]/25 flex items-center justify-between active:scale-95 transition-all duration-300 group"
        >
